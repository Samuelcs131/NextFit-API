...
export const templateResetEmail = (user: User, token: string) => {
  const template = `
                    ...
                    <tr>
                      <td class="content-cell">
                        <div class="f-fallback">
                          <h1>Olá ${user.name},</h1>
                          <p>Você solicitou recentemente a redefinição de sua senha para sua conta. Use o botão abaixo para redefini-lo.<strong> Essa redefinição de senha é válida apenas pelas próximas 2 horas.</strong></p>
                          <!-- Action -->
